...
<head>
    <meta charset="utf-8"/>
    <title>@yield('title', 'Playground')</title>
...
<div class="page-header navbar navbar-fixed-top">
    ...
    @include ('includes.quick-actions')
    <!-- BEGIN PAGE TOP -->
        <div class="page-top">
                    ...
                    <li class="dropdown dropdown-user dropdown-light">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                           data-close-others="true">
                            <span class="username username-hide-on-mobile"> Yassine Ben Slimane </span>
                            <!-- DOC: Do not remove below empty space(&nbsp;) as its purposely used -->
                            <img alt="" class="img-circle" src="http://www.gravatar.com/avatar/{{ md5('yuginim@gmail.com') }}"/>
                        </a>
